...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="#" class="menu-item" data-page="productsPage">
        ...
        <div class="content-area">
                ...
                <div class="row">
                    <div class="chart-container">
                        <div class="chart-header">
                            ...
                            <div class="chart-actions">
                                <select class="form-select" id="revenueYear" style="width: 120px;">
                    ...
                    <div class="chart-container">
                        <div class="chart-header">
                            ...
                            <div class="chart-actions">
                                <select class="form-select" id="bestSellerMonth" style="width: 120px;">
            ...
            <div id="addProductPage" style="display: none;">
                <div class="page-header">
                    ...
                    <div>
                        <button class="btn btn-secondary" id="backToProducts">
    ...
    <div class="modal" id="transactionModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="transaction-info">
                    <div class="info-row">
                        ...
                        <span class="info-value" id="modalTransactionId">TRX-20250628-001</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Tanggal:</span>
                        <span class="info-value" id="modalTransactionDate">28 Jun 2025</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Pelanggan:</span>
                        <span class="info-value" id="modalCustomer">Pelanggan 1</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Status:</span>
                        <span class="info-value"><span class="status-badge success">Selesai</span></span>
                    </div>
                </div>
                    ...
                    <table style="width: 100%; margin-top: 10px;">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td style="font-weight: 500;">Rp 125.000</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" id="printTransaction">Print</button>
                <button class="btn btn-primary" id="closeModalBtn">Tutup</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function showTransactionModal(transactionId) {
            ...
            // Set the modal title with transaction ID
            document.querySelector('#transactionModal .modal-title').textContent = `Detail Transaksi ${transactionId}`;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const revenueChart = new Chart(revenueCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Pendapatan (Rp)',
                        data: [8500000, 9200000, 10500000, 9800000, 11200000, 12450000, 0, 0, 0, 0, 0, 0],
            ...
            // Update charts when select changes
            document.getElementById('revenueYear').addEventListener('change', function() {
                // In a real app, you would fetch new data based on the selected year
                if (this.value === '2024') {
                    revenueChart.data.datasets[0].data = [7200000, 7800000, 8200000, 8800000, 9500000, 10200000, 9800000, 9200000, 8900000, 8500000, 9200000, 9700000];
                } else {
                    revenueChart.data.datasets[0].data = [8500000, 9200000, 10500000, 9800000, 11200000, 12450000, 0, 0, 0, 0, 0, 0];
                }
                revenueChart.update();
            });

            document.getElementById('bestSellerMonth').addEventListener('change', function() {
                // In a real app, you would fetch new data based on the selected month
                if (this.value === 'last') {
                    bestSellerChart.data.datasets[0].data = [38, 32, 25, 18, 12];
                } else {
                    bestSellerChart.data.datasets[0].data = [45, 38, 28, 22, 18];
                }
